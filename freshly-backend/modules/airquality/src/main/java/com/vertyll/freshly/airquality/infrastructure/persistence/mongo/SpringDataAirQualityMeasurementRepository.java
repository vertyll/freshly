...
public interface SpringDataAirQualityMeasurementRepository extends MongoRepository<AirQualityMeasurementDocument, String> {
    ...
    List<AirQualityMeasurementDocument> findByMeasurementDateBetweenOrderByMeasurementDateDesc(LocalDateTime from, LocalDateTime to);
