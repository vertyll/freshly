...
public final class ETagUtil {
    ...
    @Nullable public static String buildWeakETag(@Nullable Long version) {
        return version != null ? WEAK_PREFIX + version + "\"" : null;
    }

    @Nullable public static Long parseIfMatchToVersion(@Nullable String ifMatch) {
    ...
    private static String stripQuotes(String str) {
        if (str.length() >= 2 && str.charAt(0) == STRONG_QUOTE && str.charAt(str.length() - 1) == STRONG_QUOTE) {
