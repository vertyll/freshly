...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<Void>> verifyEmail(@RequestParam String token) {
        ...
        return ApiResponse.buildResponse(null, AUTH_EMAIL_VERIFIED_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<AccessTokenResponseDto>> login(
        ...
        ResponseCookie cookie = buildRefreshTokenCookie(tokens.refreshToken(), tokens.refreshExpiresIn());
    ...
    public ResponseEntity<ApiResponse<Void>> logout(@RefreshTokenCookie String refreshToken, HttpServletResponse response) {
        ...
        return ApiResponse.buildResponse(null, AUTH_LOGOUT_SUCCESSFUL_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> forgotPassword(@Valid @RequestBody ForgotPasswordRequestDto request) {
        ...
        return ApiResponse.buildResponse(null, AUTH_RESET_EMAIL_SENT_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> resetPassword(@Valid @RequestBody ResetPasswordRequestDto request) {
        ...
        return ApiResponse.buildResponse(null, AUTH_PASSWORD_RESET_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> changePassword(
        ...
        return ApiResponse.buildResponse(null, AUTH_PASSWORD_CHANGED_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> changeEmail(
        ...
        return ApiResponse.buildResponse(null, AUTH_EMAIL_CHANGE_INITIATED_MSG_KEY, messageSource, HttpStatus.OK);
    }
