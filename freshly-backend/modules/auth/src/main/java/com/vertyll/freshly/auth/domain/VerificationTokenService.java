...
public class VerificationTokenService {
    ...
    private static final String ERROR_TOKEN_FORMAT_INVALID_MSG_KEY = "error.auth.tokenFormatInvalid";
    private static final String ERROR_PASSWORD_RESET_TOKEN_EXPIRED_MSG_KEY = "error.auth.passwordResetTokenExpired";
    private static final String ERROR_PASSWORD_RESET_TOKEN_INVALID_MSG_KEY = "error.auth.passwordResetTokenInvalid";
    ...
    @Nullable public String extractEmail(String token) {
        try {
            Claims claims = Jwts.parser().verifyWith(getSigningKey()).build().parseSignedClaims(token).getPayload();
