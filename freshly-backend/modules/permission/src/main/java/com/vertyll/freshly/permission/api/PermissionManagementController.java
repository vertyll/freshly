...
public class PermissionManagementController {
    ...
    public ResponseEntity<ApiResponse<List<PermissionMappingResponseDto>>> getMappingsByRole(@PathVariable String role) {
        ...
        return ApiResponse.buildResponse(mappings, FETCHING_PERMISSIONS_FOR_ROLE_MSG_KEY, messageSource, HttpStatus.OK);
    }
    ...
    public ResponseEntity<ApiResponse<Void>> deleteMapping(
        ...
        permissionManagementService.deleteMapping(mappingId, ETagUtil.parseIfMatchToVersion(ifMatch));

        return ApiResponse.buildResponse(null, DELETING_PERMISSION_MAPPING_MSG_KEY, messageSource, HttpStatus.OK);
    }
}
